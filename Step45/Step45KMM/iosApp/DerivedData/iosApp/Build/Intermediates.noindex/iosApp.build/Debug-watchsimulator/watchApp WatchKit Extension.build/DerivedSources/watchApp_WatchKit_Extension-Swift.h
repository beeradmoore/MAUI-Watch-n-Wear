...
#ifndef WATCHAPP_WATCHKIT_EXTENSION_SWIFT_H
#define WATCHAPP_WATCHKIT_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="watchApp_WatchKit_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC27watchApp_WatchKit_Extension22ComplicationController")
