...
namespace WearOSApp
{
        ...
        CapabilityClient.IOnCapabilityChangedListener
    {
        ...
        async Task SetupCapability()
        {
            ...
            var capabilityInfo = await WearableClass.GetCapabilityClient(this).GetCapabilityAsync("step2_sync_count", CapabilityClient.FilterReachable);
            nodes = capabilityInfo.Nodes;

            await WearableClass.GetCapabilityClient(this).AddListenerAsync(this, "step2_sync_count");
        }
